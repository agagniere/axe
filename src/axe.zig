        ...
        fn logAt(
            ...
            nosuspend {
                ...
                if (!config.quiet) {
                    ...
                    var standard_error = std.fs.File.stderr().writer(&buffer);
                    defer standard_error.interface.flush() catch {};
                    print(src, &standard_error.interface, stderr, time, level, scope, format, args);
                }
            }
        }
